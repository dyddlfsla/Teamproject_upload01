...
$.ajax({
	type:"post",
	url:"/prj03/ps.do?method=PmareaChart",
	dataType:"json",
	success:function(data){
		ctx = document.getElementById("myAreaChart2");
		//alert(data.pareachart.labels);
		//console.log(data.areachart);
		//console.log(data.areachart.labels);
		//console.log(data.areachart.datas);
		var myLineChart = new Chart(ctx, {
			  type: 'line',
			  data: {
			    labels:data.pareachart.labels,
			    datasets: [{
			      label: "%",
			      lineTension: 0.3,
