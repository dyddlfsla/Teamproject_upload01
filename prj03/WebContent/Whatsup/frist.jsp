...
<body>
	<div id="im">
		<a href="frist.jsp"><img src="${path}/whatsup/logo.png" style="width:600px;"></a>
	</div>
	<div id="show">
		<div class="buttons buttons2" style="float:left; margin-left:40%;">
            <button type="button" class="button5" id="log">LOG IN</button>
     </div>
     <div class="buttons buttons2" style="display:inline-block;margin-left:20px;">
            <button type="button" class="button5" id="sign">JOIN</button>
     </div>
	</div>
</body>
</html>