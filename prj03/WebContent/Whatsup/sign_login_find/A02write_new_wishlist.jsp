...
<body>
   ...
   <div id="menu" >
      ...
      <table id="mainmenu">
         <tr><td><img alt="" src="img_4k\home.png" 
               style="width:20px;height:20px;text-align:center;"></td><td><a href="main.html"/>HOME</td></tr>
         <tr><td><img alt="" src="img_4k\group.png" 
               style="width:20px;height:20px;text-align:center;"></td><td><a href="groups.html"/>GROUPS</a></td></tr>
         <tr><td><img alt="" src="img_4k\cal.png" 
               style="width:20px;height:20px;text-align:center;"></td><td><a href="cal01.html"/>CALENDAR</td></tr>
         <tr><td><img alt="" src="img_4k\list.png" 
               style="width:20px;height:20px;text-align:center;"></td><td><a href="my_wishlist.html"/>BUCKET LIST</td></tr>
         <tr><td><img alt="" src="img_4k\wish.png" 
               style="width:20px;height:20px;text-align:center;"></td><td><a href="popular_wishlist.html"/>FIND WISHES</td></tr>
      </table>
   </div>
   <div id="scroll">
