...
<body>
	...
	<div id="wish01">
		...
		<col width="2%">
		<col width="78%">
			<tr><td rowspan="5"><div class="photo"><img alt="" src="./img/hawaii.png" style="height:100%;width:100%;border-radius:10px;"></div></td></tr>
	...
	<div id="wish_adv">
		<font size="1">여행</font>
		<hr>
		<img alt="" src="./img/wish_adv.png" style="height:200px;display:block;margin:auto;"><br>
