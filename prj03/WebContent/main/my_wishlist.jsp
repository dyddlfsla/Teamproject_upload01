...
<script>
   ...
   function showPopup(){
      window.open("wishList_detail_View.jsp","a","width=800, height=1600, left=100, top=50");
   }
</script>
</head>
<%-- 
   ...
   <div id="scroll">
    ...
    <div class="tabmenu" id="tab21">
        ...
        <div class="tab1_content">
            <div style="border:none;width:220px;height:20px;background:url('./img/arrow.jpg') no-repeat 95% 50%;">
               <font size="4" style="font-weight:bold;">우리가 담은 위시 2</font>
            </div><hr style="width:20%;margin-left:0;">
               <div id="wish01" align="left">
               <font size="1">여행</font>
               <hr>
               <font size="3" onclick="showPopup();" style="hover:pointer;">부산 여행가기</font><br>
