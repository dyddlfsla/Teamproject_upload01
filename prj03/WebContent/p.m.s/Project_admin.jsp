                         ...
                         <div class="row">
                            ...
                            <div class="col-xl-6" >
                              <div class="card mb-4" >
                               ...
                               <div class="card-body" >
                                <table class="table" style="width:100%; overflow: scroll;height: 300px;">
                     ...
                     <br><br><br>
                      <table class="table">
  						  <thead class="thead-dark">
							      <tr>
							        <th>프로젝트명</th>
							        <td><input name="writer" class="form-control"  placeholder="작성자 입력" /></td>
							        <th>현장</th>
							        <td><input name="writer" class="form-control"  placeholder="현장 입력" /></td>
							      </tr>
							      <tr><td></td></tr>
							       <tr>
							        <th>시작일</th>
							       ...
							       <tr>
							        ...
							        <th>팀원</th>
							        <td><input name="writer" class="form-control"  placeholder="팀원 입력" /></td>
							      </tr>
   							</thead>
  								 <tbody>
